    ...
    const arrayIDS = recipes.map(recipe => recipe.id);
    ...
    function checkSearchBar(arrayIDS) {
        ...
        recipes.forEach(recipe => {
            if (arrayIDS.indexOf(recipe.id) > -1) {
                ...
                if (recipe.name.toLowerCase().indexOf(value) > -1 || recipe.description.toLowerCase().indexOf(value) > -1 || ingr.find(ing => ing.indexOf(value) > -1)) {
                    //matchFound = true;
